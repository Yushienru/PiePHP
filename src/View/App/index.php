...
<html lang="fr">
	...
	<body>
			...
			<nav class="navbar navbar-inverse" id="menu">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a href="\PiePHP\film\show">
							<img src="\assets\logo-pour-fond-fonce.png" alt="">
						</a>
					</div>
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="\PiePHP\film\show">Les filmsd</a></li>
							<li><a href="\PiePHP\user\show">Mon compte</a></li>
							<li><a href="\PiePHP\genre\show">Genres</a></li>
							<li>
								<?php echo $button ?>
					...
					<div class="row">
						...
						<div class="col-sm-6">
						    <div class="copyright pull-right">
								<p><a href="\PiePHP\film\show">Accueil</a> | <a href="\PiePHP\film\show">Films</a></p>
							</div>						
						</div>
					</div>
				</div>
		...
		<script src="\PiePHP\webroot\js\jquery-3.3.1.js"></script>
